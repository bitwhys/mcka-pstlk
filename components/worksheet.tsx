  ...
  return (
    <div className="*:not-first:mt-2">
      <div className="flex items-center gap-4">
        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            ...
            <TooltipContent className="max-w-xs py-3">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-xs">
                  ...
                  menu by setting the <code>trigger</code> prop to <code>click</code>.
                </p>
              </div>
            </TooltipContent>
          </Tooltip>
      ...
      <Textarea
        ...
        className="bg-muted focus-visible:border-primary focus-visible:bg-card [resize:none] border-2 border-transparent text-base shadow-none"
        rows={rows}
      />
    </div>
  )
